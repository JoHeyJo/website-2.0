  ...
  return (
    <section id="Bio-about-me">
      <ul id="about-me-links container">
        ...
        <li>In my previous life I was in the bar industry for 11 years and after attending a Full Stack Web Development program at Rithm School I was able to leverage my previous experience with the tools, resources, and knowledge gained at Rithm to be a successful software engineer.</li>
      </ul>
    </section>
  )
}
